...
class PrivateKey extends _Key.default {
  ...
  static fromBytes(data) {
    let message;
    if (data.length == 32) {
      console.warn("WARNING: Consider using fromStringECDSA() or fromStringED2551() on a HEX-encoded string and fromStringDer() on a HEX-encoded string with DER prefix instead.");
    }
    try {
